...
@Slf4j
@Component
public class EmbyTelegramBotOld implements SpringLongPollingBot, LongPollingSingleThreadUpdateConsumer {
    ...
    public EmbyTelegramBotOld(@Lazy EmbyBossConfig embyBossConfig, @Lazy Command command,
